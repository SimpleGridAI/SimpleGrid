function PrivacyPage() {
  ...
  return (<>
    ...
    <main id="main" className="legal-page">
      ...
      <h2>6. Cookies and Marketing-Site Tracking</h2>
      <p>The SimpleGrid marketing website (simplegrid.ai) uses cookies and similar technologies for site functionality, analytics, and measuring the effectiveness of our marketing. This section covers the marketing website only; Platform Customer Data is governed by Sections 3 and 4 above.</p>
      <p><strong>6.1 Cookie categories:</strong></p>
      <ul>
        <li><strong>Necessary</strong> - site security and core functionality</li>
        <li><strong>Functional</strong> - preferences (including your cookie consent choice)</li>
        <li><strong>Analytics</strong> - measure how visitors use the site so we can improve it</li>
      </ul>
      <p><strong>6.2 Third-party services on the marketing website:</strong></p>
      <ul>
        <li><strong>PostHog</strong> - product analytics</li>
        <li><strong>Google Analytics 4</strong> - aggregate traffic and campaign measurement</li>
        <li><strong>Cal.com</strong> - used when you book a demo call</li>
      </ul>
      <p><strong>6.3 Consent and your preferences:</strong> Analytics cookies do not load until you click <strong>Accept</strong> on our cookie banner. If you click <strong>Decline</strong>, or never interact with the banner, no analytics are loaded. You can revoke a previous acceptance at any time by clearing site data in your browser, or by emailing <a href="mailto:hello@simplegrid.ai" style={{color:'var(--sg-blue)'}}>hello@simplegrid.ai</a>.</p>
      <p><strong>6.4 Regional rights:</strong> If you are in the European Economic Area (GDPR), the United Kingdom (UK GDPR), California (CPRA), or India (DPDP Act 2023), you may have additional rights including access, correction, deletion, restriction, data portability, and opt-out of certain processing. Contact <a href="mailto:hello@simplegrid.ai" style={{color:'var(--sg-blue)'}}>hello@simplegrid.ai</a> to exercise these rights.</p>

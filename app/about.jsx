  ...
  return (<>
    ...
    <section className="section section-dark final-cta">
      <div className="container">
        ...
        <p className="sub" style={{color:'rgba(255,255,255,0.75)', maxWidth:680, margin:'18px auto 0'}}>Limited capacity each quarter. We only take on customers we know we can win for - because we carry the cost and the risk of the build, and we only get paid when you succeed. We are built for mid-market manufacturers, roughly $5M-$250M in revenue - below that, spreadsheets or QuickBooks still win; above that, SAP or Oracle make more sense.</p>
        ...
        <p className="note" style={{color:'rgba(255,255,255,0.5)', marginTop:14}}>Senior engineers and deployment experts on every deployment · We reply within 48 hours</p>

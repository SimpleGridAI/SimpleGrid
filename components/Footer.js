...
function Footer() {
  ...
  const cols = [{
    ...
    links: [{
      ...
      l: 'Job Cost Calculator',
      href: 'tools/job-cost-calculator/'
    }, {
      l: 'BOM Builder',
      href: 'tools/bill-of-materials-template/'
    }, {
      l: 'Production Schedule',
      href: 'tools/production-schedule-template/'
    }, {
  ...
  const contact = [{
    ...
    kind: 'calendar',
    l: 'Book a call with the founder',

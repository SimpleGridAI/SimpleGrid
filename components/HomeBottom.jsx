...
function Integrations() {
  ...
  const items = [
    ...
    { name: 'Tally', status: 'live', svg: '<svg viewBox="0 0 40 40" width="24" height="24" aria-hidden="true"><rect width="40" height="40" rx="6" fill="#263238"/><text x="20" y="26" text-anchor="middle" fill="#fff" font-family="sans-serif" font-weight="700" font-size="16">T</text></svg>' },
        ...
        <Reveal delay={200}>
          <div style={{overflowX:'auto'}}>
            <table className="compare-table">
              <thead><tr><th></th><th>SAP / Oracle NetSuite</th><th>Epicor / Plex</th><th>QuickBooks + Excel</th><th>SimpleGrid</th></tr></thead>
              <tbody>
                {rows.map((r,i) => (

...
function IntegrationsBar() {
  const items = ['WhatsApp', 'Slack', 'Gmail', 'Excel', 'Google Sheets', 'QuickBooks', 'Tally', 'Shopify', 'Amazon', 'ShipStation'];
  ...
  }, "Integrates with"), items.map((it, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    style: {
      fontFamily: 'var(--font-heading)',
      fontSize: 14,
...
function WhatWeDo() {
  ...
  }, "Our founder personally builds and deploys every system. We run tight to keep the experience exceptional."))), /*#__PURE__*/React.createElement(Reveal, {
    delay: 150
  }, /*#__PURE__*/React.createElement("div", {
...
function HowItWorks() {
  ...
  const cards = [{
    ...
    details: [{
      kind: 'p',
      text: "Day 1 is a 3-hour live video call with Mukund - our founder, not a sales rep, not an SDR. We walk through your operations end-to-end: how orders come in, who approves what, your production stages, vendor relationships, QC rules, dispatch, and the exceptions every floor has."
    }, {
      kind: 'p',

...
function EventsLedger() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "al-callout-tag"
  }, "WHAT THIS GIVES YOU")), /*#__PURE__*/React.createElement("div", {
    className: "al-grid"
  }, /*#__PURE__*/React.createElement(Reveal, null, /*#__PURE__*/React.createElement("div", {
    className: "al-rows"
  }, [{
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v5h5"/><path d="M3.05 13A9 9 0 1 0 6 5.3L3 8"/><path d="M12 7v5l4 2"/></svg>',
    t: 'Replay any day, any hour',
    p: 'Open a day, watch events in order. The reason is in the log: name, time, what changed.'
  }, {
    ...
    p: 'Vendor says 500 sheets. Log says 450, received by Mike, 11:46 AM Tuesday. Argument over before it starts.'
  }, {
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect width="8" height="4" x="8" y="2" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="m9 14 2 2 4-4"/></svg>',
    t: 'Audit-ready by default',
    p: 'IRS, OSHA, SOX, buyer audits. Every event already timestamped and named. Filter, export, send.'
  }, {
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg>',
    t: 'Mistakes are reversible, never hidden',
    p: 'Issue a corrective event. Original stays, correction sits next to it. Nothing overwritten.'
  }, {
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14a9 3 0 0 0 18 0V5"/><path d="M3 12a9 3 0 0 0 18 0"/></svg>',
    t: 'One source of truth, forever',
    p: 'Inventory, AR, AP, production all computed from one log, real time. No reconciliation.'
  }, {
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="m16 11 2 2 4-4"/></svg>',
    ...
    delay: 120
  }, /*#__PURE__*/React.createElement(ActivityFeed, null)))), /*#__PURE__*/React.createElement("style", null, `
